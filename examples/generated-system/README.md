> This file is a **sample export**, not the product README. The configurator
> writes a `README.md` like this for each system you build. The project itself
> is described at the [repo root](../../README.md).
>
> The default system used to be named DS.by.MD. Some lines below (Lucide,
> “Scalable Designs Sync”) are from that older export and are kept as-is.
