...
export const COMPONENT_COLOR_FIELDS: Record<string, PreviewColorField[]> = {
  ...
  "Checkbox": ['brandSolid', 'onBrand', 'neutralText', 'disabledBg', 'disabledText', 'border'],
  "CheckboxGroup": ['brandSolid', 'onBrand', 'neutralText', 'border', 'fgMuted'],
  "Chip": ['brandSolid', 'brandText', 'neutralText', 'border'],
  "CloseButton": ['brandSolid', 'neutralText', 'fgMuted'],
  "Combobox": ['surface', 'brandSolid', 'brandText', 'neutralFill', 'neutralText', 'border', 'borderDefault', 'fgMuted', 'placeholderText'],
  ...
  "Field": ['neutralText', 'errorColor', 'border', 'fgMuted', 'placeholderText'],
  ...
  "InputOTP": ['brandSolid', 'neutralText', 'errorColor', 'border'],
  "InputStepper": ['neutralText', 'border', 'fgMuted'],
  "InputTag": ['brandSolid', 'brandText', 'neutralText', 'border', 'placeholderText'],
  "Label": ['neutralText', 'errorColor'],
  "Modal": ['surface', 'onBrand', 'neutralFill', 'neutralText', 'errorColor', 'border', 'borderDefault', 'fgMuted'],
  ...
  "Radio": ['brandSolid', 'neutralText', 'disabledBg', 'disabledText', 'border'],
  "RadioGroup": ['brandSolid', 'neutralText', 'disabledBg', 'disabledText', 'border', 'fgMuted'],
  "Rating": ['neutralFill', 'neutralText', 'fgMuted', 'warningColor'],
  "ScrollArea": ['surface', 'neutralFill', 'neutralText', 'borderDefault'],
  "SegmentedControl": ['neutralFill', 'neutralText', 'fgMuted'],
  ...
  "SwitchGroup": ['brandSolid', 'onBrand', 'neutralFill', 'neutralText', 'fgMuted'],
  ...
  "Toggle": ['brandSolid', 'onBrand', 'neutralFill', 'neutralText', 'disabledBg', 'disabledText'],
