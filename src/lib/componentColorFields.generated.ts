...
export const COMPONENT_COLOR_FIELDS: Record<string, PreviewColorField[]> = {
  ...
  "Combobox": ['brandSolid', 'brandText', 'neutralText', 'border', 'borderDefault', 'fgMuted', 'placeholderText'],
  "Command": ['neutralFill', 'neutralText', 'borderDefault', 'fgMuted', 'placeholderText'],
  "ContextMenu": ['neutralText', 'errorColor', 'borderDefault', 'placeholderText'],
