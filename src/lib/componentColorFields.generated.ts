...
export const COMPONENT_COLOR_FIELDS: Record<string, PreviewColorField[]> = {
  ...
  "Card": ['surface', 'brandText', 'neutralFill', 'neutralText', 'borderDefault', 'fgMuted'],
  ...
  "SwitchGroup": ['brandSolid', 'neutralFill', 'neutralText', 'fgMuted'],
  ...
  "Toggle": ['brandSolid', 'neutralFill', 'neutralText', 'disabledBg', 'disabledText'],
