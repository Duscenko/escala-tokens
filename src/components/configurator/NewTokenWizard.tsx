                  ...
                  >
                    <span
                      className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold flex-shrink-0 transition-colors ${
                        complete || active ? 'bg-accent-solid text-accent-ink' : 'bg-elevated text-fg-faint'
                      }`}
                    >
        ...
        <div className="flex items-center justify-between gap-3 px-5 h-16 border-t border-line flex-shrink-0">
          ...
          {step < totalSteps ? (
            ...
            <button
              onClick={commit}
              disabled={!canConfirm}
              className="px-5 py-2 rounded-lg text-[13px] font-semibold bg-accent-solid text-accent-ink disabled:opacity-40 transition-opacity hover:opacity-90"
            >
