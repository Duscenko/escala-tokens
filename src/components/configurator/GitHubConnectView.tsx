...
const TOKEN_URL =
  'https://github.com/settings/tokens/new?scopes=repo&description=DS.by.MD%20token%20sync'
...
export default function GitHubConnectView({ onClose }: GitHubConnectViewProps) {
  ...
  async function handleCreateRepo() {
    ...
    setRepoError(null)
    try {
      const repo = await createRepo(token, name, `${projectName} design tokens — generated by Scalable Designs`)
